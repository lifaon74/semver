...
export function compareSemVer(
  inputA: ISemVer,
  inputB: ISemVer,
  compareMode: ISemVerCompareMode = 'default',
): number {
  switch (compareMode) {
    case 'main':
...
function compareSemVerMain(inputA: ISemVer, inputB: ISemVer): number {
...
function compareSemVerPrerelease(inputA: ISemVer, inputB: ISemVer): number {
...
function compareSemVerBuild(inputA: ISemVer, inputB: ISemVer): number {
